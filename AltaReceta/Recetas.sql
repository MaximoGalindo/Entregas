...
insert into Chef values ('Pepito Perez')
insert into Chef values ('Maximo Galindo')
insert into Chef values ('Christofer Gusto')

go

insert into TipoReceta Values ('Facil')
insert into TipoReceta Values ('Medio')
insert into TipoReceta Values ('Dificil')
