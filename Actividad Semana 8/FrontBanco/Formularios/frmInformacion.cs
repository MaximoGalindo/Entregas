...
namespace BancoSLN
{
    public partial class frmInformacion : Form
    {
        ...
        private async void frmInformacion_Load(object sender, EventArgs e)
        {
        ...
        {
            string url = "https://localhost:7073/api/Cuenta/" + documento;
            var data = await ClienteHTTP.GetInstance().GetAsync(url);
            ...
            {
                if (c.Estado == "A")
                    dgvCuentasClientes.Rows.Add(new object[] { c.CBU, c.Saldo, c.TipoCuenta.ToString(), c.UltimoMovimiento, c.Estado });
                if (c.Estado == "B")
                    dataGridView1.Rows.Add(new object[] { c.CBU, c.Saldo, c.TipoCuenta.ToString(), c.UltimoMovimiento, c.Estado });
            }
